import numpy as np
def LTIFM4_SP(jj1,ii1,jj2,ii2,jj3,ii3,jj4,ii4,solPart):
        ...
        iterators = [jj1+1, ii1+1, jj2+1, ii2+1, jj3+1, ii3+1, jj4+1, ii4+1]
        if bb==0:
                sol = [sol1234["obj"]]
                sol.extend(sol1234["Delay"])
                sol.extend(iterators)
                sol.extend(sol1234["order"])
        else:
                sol = [vec[bb]["obj"]]
